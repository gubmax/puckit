import { printMessage, MessageType, boldText } from '@puckit/dev-utils'
...
export const printCopyingFailedMessage = () => {
  printMessage(MessageType.ERR, 'Copy command failed, try again')
}
...
export const printInstallingPackagesFailedMessage = () => {
  printMessage(MessageType.ERR, 'npm installation failed')
}
